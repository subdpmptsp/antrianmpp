<x-filament-panels::page>
    <div class="mx-auto w-full max-w-6xl space-y-5">
        ...
        <div class="inline-flex max-w-full flex-wrap gap-1 rounded-xl bg-gray-100 p-1 dark:bg-gray-800" role="tablist" aria-label="Pengaturan jadwal operasional">
            @foreach (['mingguan' => 'Jadwal Mingguan', 'cutoff' => 'Cutoff & Kuota', 'loket' => 'Override Loket', 'tanggal_khusus' => 'Hari Libur & Tanggal Khusus', 'log' => 'Log Perubahan'] as $tab => $label)
        ...
        @if ($activeTab === 'mingguan')
            <div class="mx-auto w-full max-w-6xl">
                <section class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                    ...
                    <div class="max-w-[560px] divide-y divide-gray-100 dark:divide-gray-800">
                        @foreach ($weeklySchedule as $index => $day)
                            <div class="py-3" style="display:grid;grid-template-columns:40px 92px 118px 18px 118px;align-items:center;column-gap:10px;">
                                ...
                                @else
                                    <p class="text-sm italic text-gray-400" style="grid-column:3 / 6;">Tutup sepanjang hari</p>
                                @endif
                                @if ((int) $day['day'] === 5 && $day['is_open'])
                                    <div class="grid grid-cols-1 gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-950 sm:grid-cols-2 dark:border-amber-900 dark:bg-amber-950/30 dark:text-amber-100" style="grid-column:2 / -1;">
